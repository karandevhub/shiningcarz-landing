    ...
    <section id="about" className="py-20 luxury-gradient">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-6xl font-bold font-playfair mb-6 text-foreground py-2">
            About
            <span className="block gold-gradient bg-clip-text text-transparent py-2">
              Shining Carz
            </span>
          </h2>
